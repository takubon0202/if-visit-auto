...
子ども向けの**マリオ風ランナーゲーム**を搭載。サイバーパンクな世界観で、if(塾)のキャラクターが冒険します。

### ゲーム仕様

- **操作方法**
  - PC: 矢印キー（←→で移動、↑/スペースでジャンプ）
  - モバイル: 画面タップで操作
- **ゲーム要素**
  - 障害物: スパイク、バグ、穴
  - アイテム: コイン（+100点）、スター（無敵）
  - ゴール: 2000mで到達
- **ビジュアル**
  - ピクセルアート風
  - ネオンカラー（シアン、マゼンタ、ライム）
...
黄色いジャケットを着た男の子がif(塾)のマスコットキャラクターです。
